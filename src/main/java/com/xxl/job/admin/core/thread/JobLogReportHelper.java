            ...
            while (!toStop) {
                ...
                try {
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        if (ret < 1) {
                            XxlJobAdminConfig.getAdminConfig().getXxlJobLogReportDao().insertSelective(xxlJobLogReport);
                        }
                    }
                ...
                if (XxlJobAdminConfig.getAdminConfig().getLogretentiondays() > 0
                    ...
                    List<Long> logIds;
                    do {
                        logIds = XxlJobAdminConfig.getAdminConfig().findClearLogIds(0, 0, clearBeforeTime, 0, 1000);
